                        ...
                        <c:forEach var="productPrice" items="${product.productPrices}" varStatus="status">
                            <div class="qty" id="price${status.index }">
                                ...
                                <div class="qty_info_icon">
                                    <strong class="product_amount"> <span>${productPrice.priceType.toString()}</span> </strong> <strong class="product_price"> <span class="price"><fmt:formatNumber type="number" value="${productPrice.price * (1 - productPrice.discountRate)}" /></span><span class="price_type">원 (<fmt:formatNumber type="number" value="${productPrice.discountRate * 100}" />% 할인가)</span> </strong>
                                    <em class="product_dsc"><s><fmt:formatNumber type="number" value="${productPrice.price}" />원</s></em>
                                </div>
                            </div>
                        </c:forEach>
                    </div>
