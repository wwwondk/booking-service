            ...
            <div class="section_my">
                ...
                <div class="my_summary">
                    <ul class="summary_board">
                        <li class="item">
                            ...
                            <a href="#" class="link_summary_board on"> <i class="spr_book2 ico_book2"></i> <em class="tit">전체</em> <span class="figure">${myCount['전체'] }</span> </a>
                        </li>
                        <li class="item">
                            <a href="#" class="link_summary_board"> <i class="spr_book2 ico_book_ss"></i> <em class="tit">이용예정</em> <span class="figure">${myCount['이용예정'] }</span> </a>
                        </li>
                        <li class="item">
                            <a href="#" class="link_summary_board"> <i class="spr_book2 ico_check"></i> <em class="tit">이용완료</em> <span class="figure">${myCount['이용완료'] }</span> </a>
                        </li>
                        <li class="item">
                            <a href="#" class="link_summary_board"> <i class="spr_book2 ico_back"></i> <em class="tit">취소·환불</em> <span class="figure">${myCount['취소환불'] }</span> </a>
                        </li>
                    </ul>
                </div>
                <!--// 예약 현황 -->
                ...
                <div class="wrap_mylist">
                    <ul class="list_cards" ng-if="bookedLists.length > 0">
                        ...
                        <c:forEach var="reservation" items="${myReservations }" varStatus="status">
                        <c:if test="${status.index == 0 or (status.index > 0 and myReservations[status.index-1].reservationType ne reservation.reservationType )}">
							...
							<div class="link_booking_details">
								<div class="card_header">
								    ...
								    <div class="middle">
								        ...
								        <span class="tit">${reservation.reservationType.getName()}</span>
								    </div>
								    <div class="right"></div>
								</div>
							</div>
						...
						<c:if test="${status.index == myReservation.size()-1 or (status.index < myReservation.size()-1 and myReservation[status.index+1].reservationType ne reservation.reservationType )}">
						</li>
						</c:if>	                   
                        </c:forEach>
                    </ul>
